...
vim.api.nvim_set_keymap("n", "<leader>j", ":bnext<CR>",
                        {noremap = true, silent = true})
vim.api.nvim_set_keymap("n", "<leader>k", ":bprev<CR>",
                        {noremap = true, silent = true})
...
vim.g.closetag_filetypes =
    "astro,eruby,template,typescriptreact,javascriptreact,vue,html,heex"
...
require("lazy").setup({
    ...
    {"williamboman/mason.nvim", opts = {}}, {
        ...
        opts = {
            ensure_installed = {
                "pyright", "gopls", "tsserver", "eslint", "solargraph",
                "clojure_lsp", "tailwindcss", "astro"
            },
            handlers = {
                ...
                ["tailwindcss"] = function()
                    require("lspconfig").tailwindcss.setup({
                        filetypes = {
                            "heex", "eruby", "typescriptreact", "html", "astro"
                        }
                    })
                end
            }
        }
    }, "neovim/nvim-lspconfig", -- Manage comments
    {"numToStr/Comment.nvim", opts = {}}, -- Manage auto pairs
    {"cohama/lexima.vim"}, -- Manage HTML completions
    "alvan/vim-closetag", -- Manage snippets
    {
        "dcampos/nvim-snippy",
        opts = {
            mappings = {
    ...
    }, "dcampos/cmp-snippy", -- Manage autocomplete
    {
        "hrsh7th/nvim-cmp",
        dependencies = {
    ...
    }, -- Manage Fuzzy Finding
    {
        ...
        config = function()
            ...
            vim.api.nvim_set_keymap("n", "<leader>sg",
                                    ...
                                    {noremap = true, silent = true})
            vim.api.nvim_set_keymap("n", "<leader>sb", ":Telescope buffers<CR>",
                                    {noremap = true, silent = true})
    ...
    }, -- Manage Formatting
    {
        "sbdchd/neoformat",
        config = function()
            vim.api.nvim_set_keymap("n", "<leader>p", ":Neoformat<CR>",
                                    {noremap = true, silent = true})
    ...
    {"heavenshell/vim-jsdoc", build = "make install"}, -- Manage Astro
    {"wuelnerdotexe/vim-astro"}, -- Manage Syntax Highlighting
    {
        ...
        config = function()
            ...
            configs.setup({
                ensure_installed = {
                    ...
                    "javascript", "html", "heex"
                },
                sync_install = false,
                highlight = {
                    enable = true,
                    disable = {
                        "typescriptreact", "javascript", "typescript", "python",
                        "html"
                    }
                },
                indent = {enable = true}
